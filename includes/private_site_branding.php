...
function private_site_branding_setting_definitions(): array {
    ...
    return [
        array_replace($shared, [
            ...
            'description' => 'Enable the trusted repository-owned Private Site Branding extension.',
            'helpText' => 'Disabling removes branding subscriptions and presentation, preserves namespaced settings, and restores standard ChatSpace fallbacks.',
        ...
        array_replace($shared, [
            ...
            'label' => 'Protected setup and database-update identity',
            'description' => 'Setup and database update preserve truthful ChatSpace identity and recovery state.',
            'helpText' => 'Branding cannot hide migration, backup, update, or recovery authority.',
            'type' => 'fixed',
            'defaultValue' => true,
            'order' => 10,
            'mandatory' => true,
        ...
        array_replace($shared, [
            ...
            'label' => 'Protected maintenance and error identity',
            'description' => 'Core failures, safe mode, authentication blocks, and moderation outcomes remain truthful.',
            'helpText' => 'The extension receives no secrets, hidden reasons, reports, sanctions, or unrestricted diagnostics.',
            'type' => 'fixed',
            'defaultValue' => true,
            'order' => 10,
            'mandatory' => true,
        ...
        array_replace($shared, [
            ...
            'label' => 'Required ChatSpace, license, source, and attribution continuity',
            'description' => 'Community branding never replaces the mandatory platform/legal section.',
            ...
            'bulkOperations' => [],
            'controlClass' => 'mandatory-fixed',
            'fixedReason' => 'Required legal/source attribution cannot be disabled.',
