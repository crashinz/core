...
function account_deletion_disposition_registry(): array
{
    return [
        ...
        'account_email_state' => 'delete-active-edge',
        'account_two_factor_email' => 'delete-active-edge',
        'account_email_challenges' => 'delete-active-edge',
        'account_two_factor' => 'delete-active-edge',
        'account_two_factor_backup' => 'delete-active-edge',
...
function account_deletion_execute(
    ...
    try {
        ...
        foreach ([
            ...
            ['account_email_state', 'user_id=?', [$userId]],
            ['account_two_factor_email', 'user_id=?', [$userId]],
            ['account_email_challenges', 'user_id=?', [$userId]],
            ['account_two_factor_backup', 'user_id=?', [$userId]],
            ['account_two_factor', 'user_id=?', [$userId]],
