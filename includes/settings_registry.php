...
function settings_registry_definitions(bool $includeInstalledGames = true): array {
    ...
    $numeric = [
        ...
        ['participant_idle_timeout_minutes', 'avatars-presence', 'presence', 'Presence & Movement', 'Idle removal minutes', 'Minutes without a room heartbeat before removing the avatar and releasing links. This does not remove a connected user just because they are quiet.', 5, 0.5, 120, 20, ['idle timeout', 'disconnected removal']],
