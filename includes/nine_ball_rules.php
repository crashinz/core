...
function nine_ball_rules_projection(): array {
    return ['label'=>'9 Ball rules','description'=>'Casual digital 9 Ball. No pocket calls. Solo practice has no foul penalties.','sections'=>[
        ...
        ['label'=>'Shot clock','text'=>'Choose 30 (default), 45 or 60 seconds per shot. Placement and push-out choices use the same time. The clock waits for balls to stop. Running out is a foul: the opponent gets ball in hand, behind the head string if the break has not been played. Timeouts count toward three consecutive fouls. Solo practice is untimed.'],
