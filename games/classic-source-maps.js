  ...
  battleship: {
    ...
    motion: {
      ...
      shot: {
        ...
        launchLeadMs: 540,
        launchByPerspective: {
          viewer: { slot: "dib-3", region: box(20, 212, 40, 40), frameCount: 45, muzzle: box(34, 239, 24, 25) },
          opponent: { slot: "dib-2", region: box(165, 267, 40, 40), frameCount: 35, muzzle: box(173, 274, 24, 25) },
        },
      ...
      impacts: {
        ...
        marker: { slot: "dib-8", nativeSize: { width: 13, height: 13 }, frameCount: 56 },
      },
      wrecks: {
      ...
      miss: { durationMs: 6660 },
      hit: { durationMs: 6660 },
      sunk: { durationMs: 7110 },
      audio: { impactStartMs: 1620, sinkStartMs: 2880, victoryStartMs: 7110 },
      victoryFlag: {
        slot: "dib-9",
        nativeSize: { width: 60, height: 60 },
        frameCount: 68,
        frameDurationMs: 90,
        durationMs: 6120,
        persistFinal: false,
